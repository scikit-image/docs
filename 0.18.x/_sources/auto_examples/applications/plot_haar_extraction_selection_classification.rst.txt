...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Computing the full feature set took 154.062s, plus 1.338s training, for an AUC of 1.00. Computing the restricted feature set took 0.133s, plus 1.139s training, for an AUC of 1.00.
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 2 minutes  39.826 seconds)
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: https://mybinder.org/badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/master?filepath=notebooks/auto_examples/applications/plot_haar_extraction_selection_classification.ipynb
      :width: 150 px
