.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_segmentation_plot_rolling_ball.py>`     to download the full example code or to run this example in your browser via Binder
    .. rst-class:: sphx-glr-example-title

    .. _sphx_glr_auto_examples_segmentation_plot_rolling_ball.py:
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_001.png
    :alt: Original image, Background, Result
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_002.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_003.png
    :alt: Background Removal with Underflow, Correct Background Removal
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_004.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_005.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_006.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_007.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_008.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_009.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_010.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. image:: /auto_examples/segmentation/images/sphx_glr_plot_rolling_ball_011.png
    :alt: Original image, Background, Result
    :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 0 minutes  14.350 seconds)


.. _sphx_glr_download_auto_examples_segmentation_plot_rolling_ball.py:
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: images/binder_badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/v0.18.x?filepath=notebooks/auto_examples/segmentation/plot_rolling_ball.ipynb
      :alt: Launch binder
      :width: 150 px
  ...
  .. container:: sphx-glr-download sphx-glr-download-python
     ...
     :download:`Download Python source code: plot_rolling_ball.py <plot_rolling_ball.py>`



  .. container:: sphx-glr-download sphx-glr-download-jupyter

     :download:`Download Jupyter notebook: plot_rolling_ball.ipynb <plot_rolling_ball.ipynb>`
