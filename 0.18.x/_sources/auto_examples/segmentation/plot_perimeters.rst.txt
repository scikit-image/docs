.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_segmentation_plot_perimeters.py>`     to download the full example code or to run this example in your browser via Binder
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: images/binder_badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/v0.18.x?filepath=notebooks/auto_examples/segmentation/plot_perimeters.ipynb
      :alt: Launch binder
      :width: 150 px
