...
.. image:: /auto_examples/features_detection/images/sphx_glr_plot_gabors_from_astronaut_001.png
    :alt: Image (original), K-means filterbank (codebook) on original image, Image (LGN-like DoG), K-means filterbank (codebook) on LGN-like DoG image
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/jni/conda/envs/all/lib/python3.8/site-packages/scipy/cluster/vq.py:574: UserWarning: One of the clusters is empty. Re-run kmeans with a different initialization.
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: https://mybinder.org/badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/master?filepath=notebooks/auto_examples/features_detection/plot_gabors_from_astronaut.ipynb
      :width: 150 px
