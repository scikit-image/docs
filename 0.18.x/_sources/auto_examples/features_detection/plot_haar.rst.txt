.. only:: html
    ...
    .. note::
        ...
        Click :ref:`here <sphx_glr_download_auto_examples_features_detection_plot_haar.py>`     to download the full example code or to run this example in your browser via Binder
...
.. image:: /auto_examples/features_detection/images/sphx_glr_plot_haar_001.png
    :alt: The different Haar-like feature descriptors, type-2-x, type-2-y, type-3-x, type-3-y, type-4
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: binder-badge
    ...
    .. image:: https://mybinder.org/badge_logo.svg
      :target: https://mybinder.org/v2/gh/scikit-image/scikit-image/master?filepath=notebooks/auto_examples/features_detection/plot_haar.ipynb
      :width: 150 px
